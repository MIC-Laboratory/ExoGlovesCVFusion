...
from vision.datasets.fruit_dataset import fruit_dataset
...
# Params for datasets
parser.add_argument("--dataset-type", default="fruit", type=str,
...
parser.add_argument('--num-epochs', '--epochs', default=200, type=int,
...
if __name__ == '__main__':
    ...
    for dataset_path in args.datasets:
        if args.dataset_type == 'voc':
            ...
            num_classes = len(dataset.class_names)
        elif args.dataset_type == 'fruit':
            dataset = fruit_dataset("data/train_zip/train",
                 transform=train_transform, target_transform=target_transform)
            label_file = os.path.join(args.checkpoint_folder, "labels.txt")
            store_labels(label_file, dataset.class_names)
            logging.info(dataset)
    ...
    if args.dataset_type == "voc":
        ...
        val_dataset = fruit_dataset("data/test_zip/test", transform=test_transform,
                                 target_transform=target_transform)
